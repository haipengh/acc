-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/usr/sql/sec_secureemail_job.sql,v 1.1 2019/02/28 02:07:54 cvsadmin Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : sec_secureemail_job
-- Changes :
...
declare
	v_prog varchar2(100) := 'EOS_SEC_SECURE_EMAIL_PROG';
	v_job varchar2(100) := 'EOS_SEC_SECURE_EMAIL_JOB';
	v_cnt number;
begin
	...
	dbms_scheduler.create_program
		...
		,program_action => 'begin eos_sec_secure_email; end;'
		,enabled => true
		,comments => 'eos secure email program - finsec'
		);
	...
	dbms_scheduler.create_job
		...
		,enabled => true
		,comments => 'eos secure email job - finsec'
		);
