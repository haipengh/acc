...
UPDATE PSOPTIONS 
SET GUID = ' ', 
SYSTEMTYPE='UAT', SHORTNAME=(select name from v$database), LONGNAME=(select name from v$database)
/
...
UPDATE PS_HRS_APP_EMAIL 
  set EMAIL_ADDR = 'peoplesoft_applicant@hrisuat.ds.acc.co.nz'      -- Change UAT to DEV for E53HCM and SIT for E54HCM 
where EMAIL_ADDR <> ' ';
/
...
set url = 'https://hris-uat.ds.acc.co.nz/psreports/ps',
opsys = '4',
uri_host = 'hris-uat.ds.acc.co.nz',
uri_port = '443',
uri_resource = 'SchedulerTransfer/ps',
uri_scheme = 'http',
uri_rpt='https://' || 'hris-uat.ds.acc.co.nz/psc/ps/EMPLOYEE/HRMS/c/CDM_RPT.CDM_RPT.GBL?Page=CDM_RPT_INDEX' || chr(38) || 'Action=U' || chr(38) || 'CDM_ID=',
...
set url = 'https://hris-uat.ds.acc.co.nz/psreports/ps',
opsys = '4',
uri_host = 'kdclea5055.ds.acc.co.nz',
uri_port = '8000',
uri_resource = 'SchedulerTransfer/ps',
uri_scheme = 'http',
uri_rpt='https://' || 'hris-uat.ds.acc.co.nz/psc/ps/EMPLOYEE/HRMS/c/CDM_RPT.CDM_RPT.GBL?Page=CDM_RPT_INDEX' || chr(38) || 'Action=U' || chr(38) || 'CDM_ID=',
...
update psurldefn 
set url = 'sftp://hrisftp:Rd1z2hoZjsJ3bqjkMEAD@kdclea5055.ds.acc.co.nz/opt/oracle/ftpattachment/PAYSLIPS'
where url_id = 'GP_SS_PSLP_FTP'
/

update psurldefn 
set url = 'https://hris-uat.ds.acc.co.nz/psp/ps/EMPLOYEE'
where url_id = 'EMP_SERVLET'
/

update psurldefn 
set url = 'https://hris-uat.ds.acc.co.nz/psp/ps/'
...
UPDATE PSURLDEFN 
SET URL = 'uattest@hrisuat.ds.acc.co.nz'      -- Change UAT to DEV for E53HCM and SIT for E54HCM
...
UPDATE PSURLDEFN 
SET URL = 'peoplesoft@hrisuat.ds.acc.co.nz'      -- Change UAT to DEV for E53HCM and SIT for E54HCM
  , LASTUPDOPRID = 'REFRESH'
  , LASTUPDDTTM = SYSDATE
...
DELETE FROM PSAPMSGDSPSTAT WHERE MACHINENAME <> 'kdclea5055.ds.acc.co.nz' OR (APPSERVER_PATH <> '/opt/oracle/pt855/config/appserv/HC92UAT' AND MACHINENAME= 'kdclea5055.ds.acc.co.nz')
/

DELETE FROM PSAPMSGDOMSTAT WHERE MACHINENAME <> 'kdclea5055.ds.acc.co.nz' OR (APPSERVER_PATH <> '/opt/oracle/pt855/config/appserv/HC92UAT' AND MACHINENAME= 'kdclea5055.ds.acc.co.nz')
/

DELETE FROM PSAPMSGQUEUESET WHERE MACHINENAME <> 'kdclea5055.ds.acc.co.nz' OR (APPSERVER_PATH <> '/opt/oracle/pt855/config/appserv/HC92UAT' AND MACHINENAME= 'kdclea5055.ds.acc.co.nz')
/
...
--
UPDATE PSAPMSGDOMSTAT SET DOMAIN_STATUS = 'A' WHERE MACHINENAME = 'kdclea5055.ds.acc.co.nz' AND APPSERVER_PATH = '/opt/oracle/pt855/config/appserv/HC92UAT'
/

UPDATE PSIBDSPSTATVW SET DSPSTATUS = '0', STATUSSTRING = 'ACT' WHERE MACHINENAME = 'kdclea5055.ds.acc.co.nz' AND DISPATCHERNAME = 'PSBRKDSP_dflt' AND APPSERVER_PATH = '/opt/oracle/pt855/config/appserv/HC92UAT'
/

UPDATE PSIBDSPSTATVW SET DSPSTATUS = '0', STATUSSTRING = 'ACT' WHERE MACHINENAME = 'kdclea5055.ds.acc.co.nz' AND DISPATCHERNAME = 'PSPUBDSP_dflt' AND APPSERVER_PATH = '/opt/oracle/pt855/config/appserv/HC92UAT'
/

UPDATE PSIBDSPSTATVW SET DSPSTATUS = '0', STATUSSTRING = 'ACT' WHERE MACHINENAME = 'kdclea5055.ds.acc.co.nz' AND DISPATCHERNAME = 'PSSUBDSP_dflt' AND APPSERVER_PATH = '/opt/oracle/pt855/config/appserv/HC92UAT'
/
...
update psgateway
set connurl = 'https://hris-uat.ds.acc.co.nz/PSIGW/PeopleSoftListeningConnector'
/
...
set URI_TEXT = 'https://hris-uat.ds.acc.co.nz/psc/ps/'
where MSGNODENAME='PSFT_HR'
and URI_TYPE = 'CN'
/

update PSNODEURITEXT
set URI_TEXT = 'https://hris-uat.ds.acc.co.nz/psp/ps/'
where MSGNODENAME='PSFT_HR'
and URI_TYPE = 'PL'
/
...
/
insert into PSWEBPROFNVP(webprofilename, propertyname, pt_propvalue, pt_lpropvalue) values('TEST', 'PSWEBSERVERNAME', ' ', 'hris-uat.ds.acc.co.nz')
/
