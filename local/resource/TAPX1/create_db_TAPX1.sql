-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/TAPX1/create_db_TAPX1.sql,v 1.1 2014/02/18 01:07:57 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE TAPX1
   -- general section
	USER SYS IDENTIFIED BY SYS_TAPX1
	USER SYSTEM IDENTIFIED BY SYSTEM_TAPX1
	CONTROLFILE REUSE
	MAXINSTANCES 2
	MAXDATAFILES 1024
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/TAPX1/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/TAPX1/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/TAPX1/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/TAPX1/redo04b.log') SIZE 50M
   -- tablespace section
