-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/TARB3/create_db_TARB3.sql,v 1.1 2013/06/12 22:33:16 hongh Exp $
-- ----------------------------------------------------------------------------------------------
...
CREATE DATABASE TARB3
   -- general section
	USER SYS IDENTIFIED BY SYS_TARB3
	USER SYSTEM IDENTIFIED BY SYSTEM_TARB3
	CONTROLFILE REUSE
	MAXINSTANCES 32
	MAXDATAFILES 2048
