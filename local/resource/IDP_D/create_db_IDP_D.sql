-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/IDP_D/create_db_IDP_D.sql,v 1.1 2010/01/14 04:17:46 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE IDP_D
   -- general section
	USER SYS IDENTIFIED BY SYS_IDP_D
	USER SYSTEM IDENTIFIED BY SYSTEM_IDP_D
	CONTROLFILE REUSE
	MAXINSTANCES 2
	MAXDATAFILES 1024
   ...
   -- database logging section
	...
	--FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/IDP_D/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/IDP_D/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/IDP_D/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/IDP_D/redo04b.log') SIZE 50M
   -- tablespace section
