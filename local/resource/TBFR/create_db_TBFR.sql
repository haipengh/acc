-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/TBFR/create_db_TBFR.sql,v 1.1 2010/11/15 22:34:01 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE TBFR
   -- general section
	USER SYS IDENTIFIED BY SYS_TBFR
	USER SYSTEM IDENTIFIED BY SYSTEM_TBFR
	CONTROLFILE REUSE
	MAXINSTANCES 4
	MAXDATAFILES 2048
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/TBFR/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/TBFR/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/TBFR/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/TBFR/redo04b.log') SIZE 50M
   -- tablespace section
