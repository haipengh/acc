-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/OMSREPO/create_db_OMSREPO.sql,v 1.1 2010/02/17 01:22:56 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE OMSREPO
   -- general section
	USER SYS IDENTIFIED BY SYS_OMSREPO
	USER SYSTEM IDENTIFIED BY SYSTEM_OMSREPO
	CONTROLFILE REUSE
	MAXINSTANCES 2
	MAXDATAFILES 1024
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/OMSREPO/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/OMSREPO/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/OMSREPO/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/OMSREPO/redo04b.log') SIZE 50M
   -- tablespace section
