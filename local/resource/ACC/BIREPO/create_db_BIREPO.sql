-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/BIREPO/create_db_BIREPO.sql,v 1.1 2010/01/19 02:15:34 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE BIREPO
   -- general section
	USER SYS IDENTIFIED BY SYS_BIREPO
	USER SYSTEM IDENTIFIED BY SYSTEM_BIREPO
	CONTROLFILE REUSE
	MAXINSTANCES 2
	MAXDATAFILES 1024
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/BIREPO/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/BIREPO/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/BIREPO/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/BIREPO/redo04b.log') SIZE 50M
   -- tablespace section
