-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/IDP_T/create_db_IDP_T.sql,v 1.1 2010/02/02 21:46:00 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE IDP_T
   -- general section
	USER SYS IDENTIFIED BY SYS_IDP_T
	USER SYSTEM IDENTIFIED BY SYSTEM_IDP_T
	CONTROLFILE REUSE
	MAXINSTANCES 2
	MAXDATAFILES 1024
   ...
   -- database logging section
	...
	--FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/IDP_T/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/IDP_T/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/IDP_T/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/IDP_T/redo04b.log') SIZE 50M
   -- tablespace section
