-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/TWCMCSMP/create_db_TWCMCSMP.sql,v 1.1 2010/02/04 22:46:36 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE TWCMCSMP
   -- general section
	USER SYS IDENTIFIED BY SYS_TWCMCSMP
	USER SYSTEM IDENTIFIED BY SYSTEM_TWCMCSMP
	CONTROLFILE REUSE
	MAXINSTANCES 2
	MAXDATAFILES 1024
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/TWCMCSMP/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/TWCMCSMP/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/TWCMCSMP/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/TWCMCSMP/redo04b.log') SIZE 50M
   -- tablespace section
