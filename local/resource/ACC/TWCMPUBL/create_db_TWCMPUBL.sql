-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/TWCMPUBL/create_db_TWCMPUBL.sql,v 1.1 2010/03/02 00:20:19 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE TWCMPUBL
   -- general section
	USER SYS IDENTIFIED BY SYS_TWCMPUBL
	USER SYSTEM IDENTIFIED BY SYSTEM_TWCMPUBL
	CONTROLFILE REUSE
	MAXINSTANCES 2
	MAXDATAFILES 1024
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/TWCMPUBL/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/TWCMPUBL/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/TWCMPUBL/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/TWCMPUBL/redo04b.log') SIZE 50M
   -- tablespace section
