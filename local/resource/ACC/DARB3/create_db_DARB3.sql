-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/DARB3/create_db_DARB3.sql,v 1.1 2012/07/31 23:20:01 hongh Exp $
-- ----------------------------------------------------------------------------------------------
...
CREATE DATABASE DARB3
   -- general section
	USER SYS IDENTIFIED BY SYS_DARB3
	USER SYSTEM IDENTIFIED BY SYSTEM_DARB3
	CONTROLFILE REUSE
	MAXINSTANCES 32
	MAXDATAFILES 2048
