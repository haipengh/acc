-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/AIBSAND/create_db_AIBSAND.sql,v 1.1 2010/11/15 22:40:48 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE AIBSAND
   -- general section
	USER SYS IDENTIFIED BY SYS_AIBSAND
	USER SYSTEM IDENTIFIED BY SYSTEM_AIBSAND
	CONTROLFILE REUSE
	MAXINSTANCES 4
	MAXDATAFILES 2048
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/AIBSAND/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/AIBSAND/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/AIBSAND/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/AIBSAND/redo04b.log') SIZE 50M
   -- tablespace section
