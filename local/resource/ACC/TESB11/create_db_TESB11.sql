-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/TESB11/create_db_TESB11.sql,v 1.1 2013/01/31 01:40:34 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE TESB11
   ...
   LOGFILE 
	GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/TESB11/redo01b.log') SIZE 50M, 
	GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/TESB11/redo02b.log') SIZE 50M, 
	GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/TESB11/redo03b.log') SIZE 50M,
	GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/TESB11/redo04b.log') SIZE 50M
   CHARACTER SET AL32UTF8	
   --NATIONAL CHARACTER SET AL16UTF16 
   USER SYS IDENTIFIED BY SYS_TESB11
   USER SYSTEM IDENTIFIED BY SYSTEM_TESB11
/
