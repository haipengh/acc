-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/DWCM2/create_db_DWCM2.sql,v 1.1 2010/01/12 03:18:08 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE DWCM2
   -- general section
	USER SYS IDENTIFIED BY SYS_DWCM2
	USER SYSTEM IDENTIFIED BY SYSTEM_DWCM2
	CONTROLFILE REUSE
	MAXINSTANCES 2
	MAXDATAFILES 1024
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/DWCM2/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/DWCM2/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/DWCM2/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/DWCM2/redo04b.log') SIZE 50M
   -- tablespace section
