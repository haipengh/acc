-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/TWCMINTR/create_db_TWCMINTR.sql,v 1.1 2010/02/04 22:55:48 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE TWCMINTR
   -- general section
	USER SYS IDENTIFIED BY SYS_TWCMINTR
	USER SYSTEM IDENTIFIED BY SYSTEM_TWCMINTR
	CONTROLFILE REUSE
	MAXINSTANCES 2
	MAXDATAFILES 1024
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/TWCMINTR/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/TWCMINTR/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/TWCMINTR/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/TWCMINTR/redo04b.log') SIZE 50M
   -- tablespace section
