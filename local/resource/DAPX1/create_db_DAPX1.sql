-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/DAPX1/create_db_DAPX1.sql,v 1.1 2010/06/08 03:05:05 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE DAPX1
   -- general section
	USER SYS IDENTIFIED BY SYS_DAPX1
	USER SYSTEM IDENTIFIED BY SYSTEM_DAPX1
	CONTROLFILE REUSE
	MAXINSTANCES 2
	MAXDATAFILES 1024
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/DAPX1/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/DAPX1/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/DAPX1/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/DAPX1/redo04b.log') SIZE 50M
   -- tablespace section
