-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/E54HCM/create_db_E54HCM.sql,v 1.3 2014/09/24 08:19:07 cvsadmin Exp $
-- ----------------------------------------------------------------------------------------------
...
CREATE DATABASE &_ORACLE_UNQNAME.
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('&_REDO_BASE_1./redo1_1.log', '&_REDO_BASE_2./redo1_2.log') SIZE 500M REUSE, 
		GROUP 2 ('&_REDO_BASE_1./redo2_1.log', '&_REDO_BASE_2./redo2_2.log') SIZE 500M REUSE, 
		GROUP 3 ('&_REDO_BASE_1./redo3_1.log', '&_REDO_BASE_2./redo3_2.log') SIZE 500M REUSE,
		GROUP 4 ('&_REDO_BASE_1./redo4_1.log', '&_REDO_BASE_2./redo4_2.log') SIZE 500M REUSE
   -- tablespace section
	EXTENT MANAGEMENT LOCAL 
	DATAFILE '&_DBF_BASE./system01.dbf' SIZE 500M REUSE AUTOEXTEND ON NEXT 10240K MAXSIZE 8G
