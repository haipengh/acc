-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/TEGW/create_db_TEGW.sql,v 1.1 2010/10/06 21:26:33 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE TEGW
   -- general section
	USER SYS IDENTIFIED BY SYS_TEGW
	USER SYSTEM IDENTIFIED BY SYSTEM_TEGW
	CONTROLFILE REUSE
	MAXINSTANCES 4
	MAXDATAFILES 2048
   ...
   -- database logging section
	...
	FORCE LOGGING
	LOGFILE 
		GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/TEGW/redo01b.log') SIZE 50M, 
		GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/TEGW/redo02b.log') SIZE 50M, 
		GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/TEGW/redo03b.log') SIZE 50M,
		GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/TEGW/redo04b.log') SIZE 50M
   -- tablespace section
