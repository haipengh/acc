...
update PSPRCSPARMS
set PARMLIST = REPLACE(PARMLIST, 'HCPRD', 'HCUPG'), 
    ORIGPARMLIST = REPLACE(ORIGPARMLIST, 'HCPRD', 'HCUPG')
/
...
set url = 'https://hrisrep.ds.acc.co.nz:8443/psreports/HCUPG',
opsys = '4',
uri_host = 'hrisrep.ds.acc.co.nz',uri_port = '8080',
uri_resource = 'SchedulerTransfer/HCUPG',
uri_scheme = 'http',
...
DELETE FROM PSAPMSGDSPSTAT WHERE MACHINENAME <> 'hrisrep' OR (APPSERVER_PATH <> '/opt/oracle/pt849/appserv/HCUPG' AND MACHINENAME= 'hrisrep')
/

DELETE FROM PSAPMSGDOMSTAT WHERE MACHINENAME <> 'hrisrep' OR (APPSERVER_PATH <> '/opt/oracle/pt849/appserv/HCUPG' AND MACHINENAME= 'hrisrep')
/

DELETE FROM PSAPMSGQUEUESET WHERE MACHINENAME <> 'hrisrep' OR (APPSERVER_PATH <> '/opt/oracle/pt849/appserv/HCUPG' AND MACHINENAME= 'hrisrep')
/


UPDATE PSAPMSGDOMSTAT SET DOMAIN_STATUS= 'A' WHERE MACHINENAME= 'hrisrep' AND APPSERVER_PATH= '/opt/oracle/pt849/appserv/HCUPG'
/

UPDATE PSIBDSPSTATVW SET DSPSTATUS='0',STATUSSTRING='ACT' WHERE MACHINENAME='hrisrep' AND DISPATCHERNAME='PSBRKDSP_dflt' AND APPSERVER_PATH='/opt/oracle/pt849/appserv/HCUPG'
/

UPDATE PSIBDSPSTATVW SET DSPSTATUS='0',STATUSSTRING='ACT' WHERE MACHINENAME='hrisrep' AND DISPATCHERNAME='PSPUBDSP_dflt' AND APPSERVER_PATH='/opt/oracle/pt849/appserv/HCUPG'
/

UPDATE PSIBDSPSTATVW SET DSPSTATUS='0',STATUSSTRING='ACT' WHERE MACHINENAME='hrisrep' AND DISPATCHERNAME='PSSUBDSP_dflt' AND APPSERVER_PATH='/opt/oracle/pt849/appserv/HCUPG'
/
