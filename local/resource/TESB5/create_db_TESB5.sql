-- $Header: /u999/cvsadmin/cms_rep/repository/local_acc/resource/TESB5/create_db_TESB5.sql,v 1.1 2011/05/11 01:28:34 hongh Exp $
-- ----------------------------------------------------------------------------------------------
-- Script  : init_db.sql
-- Author  : Haipeng Hong
-- Purpose : 
...
CREATE DATABASE TESB5
   ...
   LOGFILE 
	GROUP 1 ('${DBF_BASE}/redo01a.log', '${ARCH_ROOT}/oradata/TESB5/redo01b.log') SIZE 50M, 
	GROUP 2 ('${DBF_BASE}/redo02a.log', '${ARCH_ROOT}/oradata/TESB5/redo02b.log') SIZE 50M, 
	GROUP 3 ('${DBF_BASE}/redo03a.log', '${ARCH_ROOT}/oradata/TESB5/redo03b.log') SIZE 50M,
	GROUP 4 ('${DBF_BASE}/redo04a.log', '${ARCH_ROOT}/oradata/TESB5/redo04b.log') SIZE 50M
   CHARACTER SET AL32UTF8	
   --NATIONAL CHARACTER SET AL16UTF16 
   USER SYS IDENTIFIED BY SYS_TESB5
   USER SYSTEM IDENTIFIED BY SYSTEM_TESB5
/
